...
(function () {
  ...
  const NAV_PINNED = [
    ...
    // Big teal "TELEMEDICINA" CTA — same large shape/size as VOLUNTARIOS, medical teal, video-consult icon.
    { label: 'TELEMEDICINA', href: '/telemedicina', m: ['/telemedicina'], telemed: true, d: 'M15 10l4.55-2.28A1 1 0 0121 8.62v6.76a1 1 0 01-1.45.9L15 14M4 6h9a2 2 0 012 2v8a2 2 0 01-2 2H4a2 2 0 01-2-2V8a2 2 0 012-2z' },
  ...
  const NAV_GROUPS = [
    { label: 'Sismos y Daños', d: 'M9 20l-5.4 2.7A1 1 0 012 21.8V6.6a1 1 0 01.55-.9L9 2.5m0 17.5l6 3m-6-3V2.5m6 20.5l5.45-2.72a1 1 0 00.55-.9V4.2a1 1 0 00-1.45-.9L15 5.5m0 17.5V5.5m0 0L9 2.5', items: [
      ...
      { label: 'Riesgo La Guaira', href: '/laguaira', m: ['/laguaira', '/laguaira.html'], d: 'M3 12h4l2 7 4-14 2 7h6' },
    ...
    { label: 'Ayuda y Suministros', d: 'M20.8 4.6a5.5 5.5 0 00-7.8 0L12 5.6l-1-1a5.5 5.5 0 00-7.8 7.8l1 1L12 21l7.8-7.6 1-1a5.5 5.5 0 000-7.8z', items: [
      ...
      { label: 'Edificios — Daño y Costos', href: '/edificios', m: ['/edificios', '/edificios.html'], d: 'M3 21h18M5 21V7l7-4 7 4v14M9 9h.01M9 13h.01M9 17h.01M15 9h.01M15 13h.01M15 17h.01' },
      ...
      { label: 'Mapa GPS en Vivo', href: '/admin/flota/live', m: ['/admin/flota/live'], d: 'M9 20l-5.4 2.7A1 1 0 012 21.8V6.6a1 1 0 01.55-.9L9 2.5m0 17.5l6 3m-6-3V2.5m6 20.5l5.45-2.72a1 1 0 00.55-.9V4.2a1 1 0 00-1.45-.9L15 5.5m0 17.5V5.5m0 0L9 2.5M12 8a2 2 0 100 4 2 2 0 000-4z' },
      { label: 'Vetar Duplicados (Rostro)', href: '/admin/dup-review', m: ['/admin/dup-review'], d: 'M12 11a4 4 0 100-8 4 4 0 000 8zm-7 9a7 7 0 0114 0M16 11l2 2 4-4' },
    ...
    { label: 'Información', d: 'M12 6.25C10.5 5 8.5 4.5 4 4.5v13c4.5 0 6.5.5 8 1.75M12 6.25C13.5 5 15.5 4.5 20 4.5v13c-4.5 0-6.5.5-8 1.75M12 6.25v13', items: [
      ...
      { label: 'Organización', href: '/organizacion', m: ['/organizacion', '/organizacion.html'], d: 'M12 2.5l8 3.2v5.1c0 4.6-3.2 8-8 9.7-4.8-1.7-8-5.1-8-9.7V5.7l8-3.2z M9 12l2 2 4-4.5' },
      { label: 'Hoja de Ruta', href: '/roadmap', m: ['/roadmap'], d: 'M9 20l-5.4 2.7A1 1 0 012 21.8V6.6a1 1 0 01.55-.9L9 2.5m0 17.5l6 3m-6-3V2.5m6 20.5l5.45-2.72a1 1 0 00.55-.9V4.2a1 1 0 00-1.45-.9L15 5.5m0 17.5V5.5m0 0L9 2.5' },
      { label: 'Agradecimientos', href: '/gracias', m: ['/gracias'], d: 'M20.8 4.6a5.5 5.5 0 00-7.8 0L12 5.6l-1-1a5.5 5.5 0 00-7.8 7.8l1 1L12 21l7.8-7.6 1-1a5.5 5.5 0 000-7.8z' },
    ] },
  ];
  ...
  const deskCss = `
    ...
    /* "Evaluación" — regular nav-item frame (icon over label) in RED, links to /informe-danos. */
    #s911-deskbar .s911-dnav-item.s911-dnav-informe{color:${CTARED};font-weight:800}
    #s911-deskbar .s911-dnav-item.s911-dnav-informe .s911-dico{background:rgba(214,40,40,.10);color:${CTARED}}
    #s911-deskbar .s911-dnav-item.s911-dnav-informe:hover{background:#fdecec;color:${CTARED}}
    #s911-deskbar .s911-dnav-item.s911-dnav-informe.active .s911-dico{background:${CTARED};color:#fff;box-shadow:0 2px 8px rgba(214,40,40,.4)}
