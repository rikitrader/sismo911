...
const HELP_ES = [
  ...
  '2) Elige una FOTO (galería o cámara) o un ARCHIVO PDF o Word (.docx). Sirve una cédula, un volante de desaparecido, un reporte o una lista de personas.',
...
const HELP_EN = [
  ...
  '2) Choose a PHOTO (gallery or camera) or a PDF/Word (.docx) FILE. An ID card, a missing-person flyer, a report, or a list of people all work.',
